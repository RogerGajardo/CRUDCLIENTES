...
public class Test_Obtener1 {
	...
	public void cuandoFindByIdEntoncesTieneTodosSusDatos() {
		...
		Clientes clienteOriginal = new Clientes("1111111-1", "Juan 1", "Gonzales 1", "example@example.cl", "11111111");
		boolean sonIguales = juan1.equals(clienteOriginal);
